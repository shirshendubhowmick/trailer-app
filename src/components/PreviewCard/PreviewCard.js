...
const PreviewCard = props => (
  <div styleName="container" style={{ backgroundImage: `url(${imageURL}/${props.eventCode}.jpg)` }}>
    ...
    <div styleName="content">
      <iframe src={`https://www.youtube.com/embed/${getYoutubeVideoID(props.movieData.TrailerURL)}`} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true} styleName="youtube-frame" />
